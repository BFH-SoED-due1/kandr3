...
public class TimeRange {
	...
	/**
	 *
	 * @param weeks number of weeks, the reservation is recurring
	 * @return the dates in the returned TimeRange object will be shifted by the number of weeks, which is specified in the parameter 'weeks'
	 */
